'use strict';
// Bank of Mongolia exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bom';
...
/** Latest rate for one pair, e.g. getRate('USD', 'MNT', { apiKey }). */
